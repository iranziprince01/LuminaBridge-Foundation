        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap">
          <Button size="sm" className="w-full sm:w-auto" asChild>
            <Link href={participant} target="_blank" rel="noopener noreferrer">
              <AppIcon name="Mic2" className="h-3.5 w-3.5" />
              Participant
          ...
          <Button size="sm" variant="outline" className="w-full sm:w-auto" asChild>
            <Link href={attendance} target="_blank" rel="noopener noreferrer">
              <AppIcon name="CalendarDays" className="h-3.5 w-3.5" />
              Attendance
              <ExternalLink className="h-3 w-3 opacity-70" />
            </Link>
          </Button>
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2">
        <div className="flex flex-col rounded-xl border border-border/60 bg-white p-5 shadow-sm">
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-secondary/10">
            <AppIcon name="Mic2" className="h-5 w-5 text-secondary" />
          </div>
        ...
        <div className="flex flex-col rounded-xl border border-border/60 bg-white p-5 shadow-sm">
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-primary/10">
            <AppIcon name="CalendarDays" className="h-5 w-5 text-primary" />
          </div>
